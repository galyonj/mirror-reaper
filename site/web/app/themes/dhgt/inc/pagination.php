<?php
/**
 * Add Bootstrap pagination structure to WordPress
 * To use in templates, simply call the function,
 * i.e <?php galyon_pagination(); ?>
 *
 * First, check to make sure the function does not already
 * exist. If not (and it won't, because we're making it here)
 * then we create the function and make it do some stuff.
 * TODO Rewrite this so that it's not stupid.
 */

function galyon_pagination( $pages = '', $range = 4 ) {
